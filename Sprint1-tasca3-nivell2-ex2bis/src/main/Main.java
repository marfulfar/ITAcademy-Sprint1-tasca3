...
import supportClasses.CustomComparatorByName;
import supportClasses.CustomComparatorByRate;
...
public class Main {
    public static void main(String[] args) {
        ...
        Restaurant rest3 = new Restaurant("pizza",2);
        ...
        ArrayList<Restaurant> newList = new ArrayList<>(restList);
        //ordering list with customComparator
        Collections.sort(newList, new CustomComparatorByName());


        System.out.println("After comparator");
        for (Restaurant rest:newList) {
            System.out.println(rest.getName() +" "+ rest.getRate());
        }
